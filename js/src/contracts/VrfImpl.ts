...
export type RandomnessInput = { sender: IdentityInput, seed: string, callback_fee: BigNumberish, state: RandomnessStateInput };
export type RandomnessOutput = { sender: IdentityOutput, seed: string, callback_fee: BN, state: RandomnessStateOutput };
...
export class VrfImpl extends __Contract {
